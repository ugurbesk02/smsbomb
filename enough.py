...
while 1:
    system("cls||clear")
    print("""{}
  _   _  ____ _   _ ____  _____ ___ _____ _____ _
| | | |/ ___| | | |  _ \|  ___|_ _|_   _|_   _/ |
| | | | |  _| | | | |_) | |_   | |  | |   | | | |
| |_| | |_| | |_| |  _ <|  _|  | |  | |   | | | |
 \___/ \____|\___/|_| \_\_|   |___| |_|   |_| |_|
    
    Sms: {}           {}TELEGRAM {} t.me/darkzonx1\n  
    ...
    if menu == 1:
        ...
        if tel_no == "":
            ...
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Hatalı dosya dizini. Tekrar deneyiniz.  TELEGRAM   t.me/darkzonx1")
                sleep(3)
                continue
        else:
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Hatalı telefon numarası. Tekrar deneyiniz.  TELEGRAM   t.me/darkzonx1") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail adresi (Bilmiyorsanız 'enter' tuşuna basın  TELEGRAM   t.me/darkzonx1): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        try:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Hatalı giriş yaptın. Tekrar deneyiniz.  TELEGRAM   t.me/darkzonx1") 
            sleep(3)
            continue
        system("cls||clear")
        try:
